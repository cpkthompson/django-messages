# Generated by Django 2.0.8 on 2018-08-16 14:00
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Message',
            fields=[
                ('id', models.UUIDField(default=uuid.UUID('ac180705-95c8-4125-967a-cd169089863a'), editable=False,
                ...
                ('parent_msg', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL,
                                                 related_name='next_messages', to='django_messages.Message',
